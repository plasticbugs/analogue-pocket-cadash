# ==============================================================================
# Cadash on the Pocket: timing constraints beyond the BSP's
...
set_multicycle_path -setup 4 -from $M68K -to [get_keepers {*|cadash_main:*|*}]
set_multicycle_path -hold  3 -from $M68K -to [get_keepers {*|cadash_main:*|*}]

# The Z80 (tv80) steps on cen_z80, one clock in twenty-four: its registers, and
...
set SND [get_keepers {*|cadash_sound:*|*}]
...
# The YM2151 steps on cen_ym, one clock in twenty-four.
set YM [get_keepers {*|jt51:*|*}]
...
set PIX [get_registers {*|cadash_video:*|red[*] *|cadash_video:*|green[*] \
                        *|cadash_video:*|blue[*] *|cadash_video:*|pal_rd_idx[*] \
                        *|cadash_video:*|idx_1[*] *|cadash_video:*|dsp_x[*] \
                        *|cadash_video:*|pix_index[*] \
                        *|cadash_video:*|sync_1[*] *|cadash_video:*|sync_2[*]}]
